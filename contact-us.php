        ...
        <div class="row">
            ...
            <div class="col-xl-6  col-md-6 col-12">
                <div class="contact-right">
                    ...
                    <form class="contuct-form" id="Yoyo-contact" method="POST" action="https://ethemestudio.com/demo/Yoyo/php/form-handler.php">
                        <div class="row form-group">
                            ...
                            <div class="col-12">
                                ...
                                <input type="email" placeholder="Your email" name="inputEmail" id="inputEmail" required>
                            </div>
                            <div class="col-12">
                            ...
                            <div class="col-12">
                                ...
                                <textarea class="input-textarea" name="inputMessage" rows="5" cols="30" id="inputMessage" required>Write your message here</textarea>
                            </div>
                            <div class="col-12">
...
<!-- Mirrored from ethemestudio.com/demo/Yoyo/contact-us.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 09 Mar 2024 08:53:19 GMT -->
</html>
