...
<section class="hero-section ev-common-hero" style="background-image: url(images/common-banner/shape-1.png);"> 
    <div class="container-fluid">
          <div class="ev-hero-content">
            ...
            <span><a href="index.html">Home</a> > <a href="all-collections.html"> product ></a> Single</span>
          </div>
    </div>
</section>
                              ...
                              <div class="swiper-container"> <!-- Слайдер с превью -->
                                <div class="swiper-wrapper">
                                  <div class="swiper-slide">
                                    <div class="slider__image"><img src="images/single-product/products/shape-1.png" alt="products"></div>
                                  </div>
                                  <div class="swiper-slide">
                                    <div class="slider__image"><img src="images/single-product/products/shape-2.png" alt="products"></div>
                                  </div>
                                  <div class="swiper-slide">
                                    <div class="slider__image"><img src="images/single-product/products/shape-3.png" alt="products"></div>
                                  </div>
                                  <div class="swiper-slide">
                                    <div class="slider__image"><img src="images/single-product/products/shape-4.png" alt="products"></div>
                                  </div>
                                  <div class="swiper-slide">
                                    <div class="slider__image"><img src="images/single-product/products/shape-5.png" alt="products"></div>
                                  </div>
                                </div>
                              </div>
                            </div>
            ...
            <div class="col-xl-6 col-lg-6 col-md-12 col-12">
                <div class="product-summery">
                    <div class="single-product-inner">
                        ...
                        <p class="product-txt">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusncididunt
                ...
                <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                    <div class="product-discription">
                        ...
                        <ul class="single-product-features">
                            <li><h6>Share</h6></li>
                            <li><i class="fa-solid fa-angles-right"></i><span>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium </span></li>
                            <li><i class="fa-solid fa-angles-right"></i><span>Letotam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae </span></li>
                            <li><i class="fa-solid fa-angles-right"></i><span>Vitae dicta sunt explicabo. Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit </span></li>
                            <li><i class="fa-solid fa-angles-right"></i><span>Lesed quia consequuntur magni dolores eos qui ratione voluptatem sequi nesciunt. </span></li>
                            <li><i class="fa-solid fa-angles-right"></i><span>Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit, sed quia non </span></li>
                            <li><i class="fa-solid fa-angles-right"></i><span>Rumquam eius modi tempora incidunt utritatis et quasi architecto beat labore et dolore magnam aliquam quaerat voluptatem.</span></li>
                        </ul>
                    </div>
                </div>
                            ...
                            <div class="comment-wrapper">
                                ...
                                <div class="comment-inner  d-lg-flex d-md-block">
                                    ...
                                    <div class="comment-text">
                                        <ul class="comment-top d-flex justify-content-between">
                                            <li>
                                                <h6>2024 Cyberinfomatic All Rights Reserved</h6>
                                                <span>April 21, 2021  10.40 Pm</span>
                                            </li>
                                            <li><a href="#" class="reply-btn">reply</a></li>
                                        </ul>
